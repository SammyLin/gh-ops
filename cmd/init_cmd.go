...
var initCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Println("     - Homepage URL: http://localhost")
		fmt.Println("     - Callback URL: http://localhost")
		fmt.Println("  4. Check \"Enable Device Flow\" (required!)")
		fmt.Println("  5. Click \"Register application\"")
		fmt.Println("  6. Copy the Client ID")
		fmt.Println("  7. Click \"Generate a new client secret\" and copy it")
		fmt.Println()
